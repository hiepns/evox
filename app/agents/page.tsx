...
/**
 * AGT-341: Hall of Fame — Agent Leaderboard
 *
 * Route: /agents
 * Sections: Header, Podium (top 3), Category Winners, Leaderboard table.
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="flex items-center gap-3 px-4 sm:px-6 py-4 border-b border-zinc-800/60">
        <Link href="/ceo" className="text-zinc-600 hover:text-zinc-400 text-sm transition-colors">
          &larr; Dashboard
        </Link>
