  ...
  return (
    <header className="flex h-12 shrink-0 items-center justify-between border-b border-zinc-800 bg-zinc-950 px-4">
      ...
      <div className="flex items-center gap-2">
        <span className="inline-flex items-center gap-1.5 rounded border border-zinc-800 bg-zinc-900 px-2 py-1 text-xs text-zinc-500">
      ...
      <div className="flex items-center gap-4">
        ...
        {onSettingsClick && !isViewerMode && (
          <button
            ...
            className="rounded-lg p-2 text-zinc-500 hover:bg-zinc-900 hover:text-zinc-50"
            aria-label="Settings"
          >
